...
//go:generate swagger generate server --target ../../go-celeb-poc --name GoCelebPoc --spec ../spec/root.yml

func configureFlags(api *operations.GoCelebPocAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GoCelebPocAPI) http.Handler {
	...
	if api.TestGetTestHandler == nil {
		api.TestGetTestHandler = test.GetTestHandlerFunc(func(params test.GetTestParams) middleware.Responder {
			return controllers.HandleTest(&params)
		})
	}
